# PandashAI
---
분석가 입장에서 어려운 작업은 아니지만 반복적으로 수행해야 하는 귀찮은 작업들이 있습니다.
예를 들면, 저의 경우 데이터의 요약 통계량을 산출한 뒤 시각화하는 등의 작업이 그랬습니다.
이러한 귀찮음을 대화하듯이 작성하고 결과를 바로 확인하며 사용된 코드를 가져와 내 마음대로 수정할 수 있다면, 분석의 효율이 올라갈 것이라 생각해 제작했습니다.
